...
namespace HTC.UnityPlugin.Vive
{
    public static class VIUSettingsEditor
    {
        ...
        public static bool supportSimulatedDevice
        {
            get
            {
                return VIUSettings.activateSimulatorModule;
            }
            private set
            {
        ...
        public static bool supportOpenVR
        {
            ...
            {
#if UNITY_5_3 || UNITY_5_4
                return VIUSettings.activateSteamVRModule && VRModule.isSteamVRPluginDetected;
#elif UNITY_5_5_OR_NEWER
                return ((VIUSettings.activateSteamVRModule && VRModule.isSteamVRPluginDetected) || VIUSettings.activateUnityNativeVRModule) && EnabledDevices.OpenVR.enabled;
#endif
            }
            set
            {
...
#elif UNITY_5_5_OR_NEWER
                return ((VIUSettings.activateOculusVRModule && VRModule.isOculusVRPluginDetected) || VIUSettings.activateUnityNativeVRModule) && EnabledDevices.Oculus.enabled;
#endif
            }
            set
            {
        ...
        private static void OnVIUPreferenceGUI()
        {
            ...
            {
                GUI.enabled = false;
                EditorGUILayout.ToggleLeft(new GUIContent(supportOpenVRTitle, "SteamVR Plugin not installed."), false);
                GUI.enabled = true;
            }
            ...
            {
                GUI.enabled = false;
                EditorGUILayout.ToggleLeft(new GUIContent(supportOculusVRTitle, "Oculus VR plugin not installed."), false);
                GUI.enabled = true;
